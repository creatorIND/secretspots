...
**Built upon YelpCamp (By [Colt Steele](https://www.coltsteele.com/))**

- Complete UI overhaul
- Migrated from Bootstrap to Sass/CSS
...
App link: [https://secretspots.sujalsinha.dev/](https://secretspots.sujalsinha.dev/)
